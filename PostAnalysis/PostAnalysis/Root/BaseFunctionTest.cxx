...
void PlotLandauXGaussian()
{
  ...
  TH1F* Gaus = Gaussian(0, 0.1, bins, min, max, "1"); 
...
void PlotDeconvLandauXGaussian()
{
  ...
  TH1F* Gaussian1 = Gaussian(0, 0.01, bins, min, max, "Original1"); 
  TH1F* Gaussian2 = Gaussian(0, 0.01, bins, min, max, "Original2"); 
  TH1F* Gaussian3 = Gaussian(0, 0.01, bins, min, max, "Original3"); 
  TH1F* Gaussian4 = Gaussian(0, 0.01, bins, min, max, "Original4"); 
  ...
  //  RatioPlot(Gen_Landau[i], Landau_Recon[i], can); 
  //  can -> Print("DeconvLandauXGaussian.pdf");
  //  can -> Clear(); 
