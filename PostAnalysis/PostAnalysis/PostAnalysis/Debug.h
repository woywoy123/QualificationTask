...
const static std::vector<float> k1 = {0.1, 1.8}; 
const static std::vector<float> k2 = {1.8, 3.1}; 
const static std::vector<float> k3 = {0, 9.0}; 
const static std::vector<float> k4 = {0, 9.0}; 
...
const MVF Params_N = { 
  ...
  {"Range_ntrk_3", Ranges[2]},   
  {"Range_ntrk_4", Ranges[3]},    
  {"Minimizer", {100000}}, 
  {"Print", {1}}
}; 
