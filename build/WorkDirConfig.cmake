...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.2.47)" )
endif()
...
set( WorkDir_BASE_PROJECTS AnalysisBase;21.2.47 )
...
set( WorkDir_PACKAGE_NAMES PostAnalysis )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES PostAnalysisPkg;PostAnalysisPkgPrivate;PackageLib;PostAnalysis )
